...
dict_inputs = {'zero':0,'one':1,'two':2,'three':3,'four':4,'five':5}
dict_outputs = {-5:'minus five', -4:'minus four', -3:'minus three', -2:'minus two', -1:'minus one', 0:'zero', 1:'one', 2:'two', 3:'three', 4:'four', 5:'five', 6:'six', 7:'seven', 8:'eight', 9:'nine', 10:'ten'}

def operation(a,b,c):
    if b == 'plus':
        return dict_inputs[a] + dict_inputs[c]
    else:
        return dict_inputs[a] - dict_inputs[c]

if (a not in dict_inputs) or (c not in dict_inputs) or (b not in ['plus','minus']):
    print("I am not able to answer this question. Check your input.")
else:
    result = operation(a,b,c)
    out_result = dict_outputs[result]
    print(f'{a} {b} {c} equals {out_result}')
